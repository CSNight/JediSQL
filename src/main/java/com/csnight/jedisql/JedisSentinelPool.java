...
public class JedisSentinelPool extends JedisPoolAbstract {
    ...
    public JediSQL getResource() {
        while (true) {
            ...
            final HostAndPort connection = new HostAndPort(jediSQL.getClient().getHost(), jediSQL.getClient()
                    .getPort());
    ...
    protected class MasterListener extends Thread {
        ...
        public void shutdown() {
            try {
                ...
                running.set(false);
                // This isn't good, the JediSQL object is not thread safe
                if (j != null) {
                    j.disconnect();
                }
            } catch (Exception e) {
