...
import com.csnight.jedisql.commands.BinaryJedisCommands;
...
public class BinaryShardedJedis extends Sharded<JediSQL, JedisShardInfo> implements
        BinaryJedisCommands {
    ...
    public void disconnect() {
        for (JediSQL jediSQL : getAllShards()) {
            if (jediSQL.isConnected()) {
                try {
                    jediSQL.quit();
    ...
    protected JediSQL create(JedisShardInfo shard) {
        return new JediSQL(shard);
    }
