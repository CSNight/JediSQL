...
import com.csnight.jedisql.exceptions.InvalidURIException;
import com.csnight.jedisql.exceptions.JedisDataException;
import com.csnight.jedisql.exceptions.JedisException;
import com.csnight.jedisql.params.*;
import com.csnight.jedisql.util.JedisByteHashMap;
    ...
    protected void checkIsInMultiOrPipeline() {
        if (client.isInMulti()) {
            throw new JedisDataException(
                    "Cannot use JediSQL when in Multi. Please use Transaction or reset jedis state.");
        } else if (pipeline != null && pipeline.hasPipelinedResponse()) {
            throw new JedisDataException(
                    "Cannot use JediSQL when in Pipeline. Please use Pipeline or reset jedis state .");
        }
    }
