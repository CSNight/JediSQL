...
import com.csnight.jedisql.commands.Commands;
...
public class Client extends BinaryClient implements Commands {
    ...
    public void create_db(String db) {
        create_db(SafeEncoder.encode(db));
    }

    public void create_db(String db, String path) {
        create_db(SafeEncoder.encode(db), SafeEncoder.encode(path));
    }

    public void exec(String db, String sql) {
        exec(SafeEncoder.encode(db), SafeEncoder.encode(sql));
    }

    public void exec_now(String db, String query) {
        exec_now(SafeEncoder.encode(db), SafeEncoder.encode(query));
    }

    public void query(String db, String query) {
        query(SafeEncoder.encode(db), SafeEncoder.encode(query));
    }

    public void query_now(String db, String query) {
        query_now(SafeEncoder.encode(db), SafeEncoder.encode(query));
    }

    public void query_into(String stream, String db, String query) {
        query_into(SafeEncoder.encode(stream), SafeEncoder.encode(db), SafeEncoder.encode(query));
    }

    public void query_into_now(String stream, String db, String query) {
        query_into_now(SafeEncoder.encode(stream), SafeEncoder.encode(db), SafeEncoder.encode(query));
    }

    public void create_statement(String db, String stmt_name, String stmt_query) {
        create_statement(SafeEncoder.encode(db), SafeEncoder.encode(stmt_name), SafeEncoder.encode(stmt_query));
    }

    public void create_statement_now(String db, String stmt_name, String stmt_query) {
        create_statement_now(SafeEncoder.encode(db), SafeEncoder.encode(stmt_name), SafeEncoder.encode(stmt_query));
    }

    public void delete_statement(String db, String stmt_name) {
        delete_statement(SafeEncoder.encode(db), SafeEncoder.encode(stmt_name));
    }

    public void delete_statement_now(String db, String stmt_name) {
        delete_statement_now(SafeEncoder.encode(db), SafeEncoder.encode(stmt_name));
    }

    public void update_statement(String db, String stmt_name, String stmt_query) {
        update_statement(SafeEncoder.encode(db), SafeEncoder.encode(stmt_name), SafeEncoder.encode(stmt_query));
    }

    public void update_statement_now(String db, String stmt_name, String stmt_query) {
        update_statement_now(SafeEncoder.encode(db), SafeEncoder.encode(stmt_name), SafeEncoder.encode(stmt_query));
    }

    public void copy(String db1, String db2) {
        copy(SafeEncoder.encode(db1), SafeEncoder.encode(db1));
    }

    public void copy_now(String db1, String db2) {
        copy_now(SafeEncoder.encode(db1), SafeEncoder.encode(db1));
    }
