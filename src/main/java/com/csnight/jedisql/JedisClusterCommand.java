...
import com.csnight.jedisql.util.JedisClusterCRC16;
...
public abstract class JedisClusterCommand<T> {
    ...
    public abstract T execute(JediSQL connection);
    ...
    private void releaseConnection(JediSQL connection) {
        if (connection != null) {
            connection.close();
        }
    }
