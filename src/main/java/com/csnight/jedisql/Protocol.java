...
public final class Protocol {
    ...
    public static enum Command implements ProtocolCommand {
        APPEND, ASKING, AUTH, BGREWRITEAOF, BGSAVE, BITCOUNT, BITFIELD, BITOP, BITPOS, BLPOP, BRPOP, BRPOPLPUSH, CLIENT,
        CLUSTER, CONFIG, COMMAND, DBSIZE, DEBUG, DECR, DECRBY, DEL, DISCARD, DUMP, ECHO, EVAL, EVALSHA,
        EXEC, EXISTS, EXPIRE, EXPIREAT, FLUSHALL, FLUSHDB, GEOADD, GEODIST, GEOHASH, GEOPOS, GEORADIUS, GEORADIUSBYMEMBER, GEORADIUSBYMEMBER_RO,
        GEORADIUS_RO, GET, GETBIT, GETRANGE, GETSET, HDEL, HEXISTS, HGET, HGETALL, HINCRBY, HINCRBYFLOAT, HKEYS, HLEN,
        HMGET, HMSET, HSCAN, HSET, HSETNX, HSTRLEN, HVALS, INCR, INCRBY, INCRBYFLOAT, INFO, KEYS, LASTSAVE,
        ...
        PEXPIREAT, PFADD, PFCOUNT, PFMERGE, PING, PSETEX, PSUBSCRIBE, PTTL, PUBLISH, PUBSUB,
        PUNSUBSCRIBE, QUIT, RANDOMKEY, READONLY, RENAME, RENAMENX,
        RENAMEX, RESTORE, RPOP, RPOPLPUSH, RPUSH, RPUSHX, SADD, SAVE,
        SCAN, SCARD, SCRIPT, SDIFF, SDIFFSTORE, SELECT, SENTINEL, SET, SETBIT, SETEX, SETNX, SETRANGE,
        SHUTDOWN, SINTER, SINTERSTORE, SISMEMBER, SLAVEOF, SLOWLOG, SMEMBERS, SMOVE, SORT, SPOP, SRANDMEMBER,
        SREM, SSCAN, STRLEN, SUBSCRIBE, SUBSTR, SUNION, SUNIONSTORE, SWAPDB, SYNC, TIME,
        TOUCH, TTL, TYPE, UNLINK, UNSUBSCRIBE, UNWATCH, WAIT, WATCH, XACK, XADD, XCLAIM, XDEL,
        XGROUP, XLEN, XPENDING, XRANGE, XREAD, XREADGROUP, XREVRANGE, XTRIM, ZADD, ZCARD,
        ZCOUNT, ZINCRBY, ZINTERSTORE, ZLEXCOUNT, ZPOPMIN, ZRANGE, ZRANGEBYLEX, ZRANGEBYSCORE,
        ZRANK, ZREM, ZREMRANGEBYLEX, ZREMRANGEBYRANK, ZREMRANGEBYSCORE, ZREVRANGE, ZREVRANGEBYLEX, ZREVRANGEBYSCORE, ZREVRANK, ZSCAN, ZSCORE, ZUNIONSTORE;
